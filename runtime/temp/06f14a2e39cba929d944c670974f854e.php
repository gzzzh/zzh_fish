<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:88:"C:\phpStudy\PHPTutorial\WWW\xianzhitao\public/../application/admin\view\focus\index.html";i:1547648506;s:78:"C:\phpStudy\PHPTutorial\WWW\xianzhitao\application\admin\view\public\left.html";i:1547878793;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="main-wrap">
    <div class="crumb-wrap">
        <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo url('admin/Index/index'); ?>">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">轮播图管理</span></div>
    </div>

    <div class="result-wrap">
        <div class="result-title">
            <div class="result-list">
                <a href="<?php echo url('admin/focus/add'); ?>"><i class="icon-font"></i>新增轮播图</a>
            </div>
        </div>
        <div class="result-content">
            <table class="result-tab" width="100%">
                ...
                <tr>
                    ...
                    <td><img src="/<?php echo $vo['images']; ?>" width="50px" height="50px"></td>
                    <td><?php echo $vo['sort']; ?></td>
                    <td><?php echo (isset($vo['url']) && ($vo['url'] !== '')?$vo['url']:'不跳转'); ?></td>
                    <td>
                        <?php if($vo['type'] == 1): ?>首页轮播
                        <?php else: ?>试用报告轮播
                        <?php endif; ?>
                    </td>
                    ...
                    <td>
                        <a href="<?php echo url('admin/focus/add',['id' => $vo['id']]); ?>">编辑</a>
                        &nbsp;&nbsp;
                        <a class="link-del" href="<?php echo url('admin/focus/del',['id' => $vo['id']]); ?>}" onClick="return confirm('确定操作数据?');">删除</a>
                    </td>
                </tr>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </table>
            <div class="list-page"> <ul></ul></div>
