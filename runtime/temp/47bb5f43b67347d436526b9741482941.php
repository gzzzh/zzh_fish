<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:88:"C:\phpStudy\PHPTutorial\WWW\xianzhitao\public/../application/admin\view\pay\txindex.html";i:1547878230;s:78:"C:\phpStudy\PHPTutorial\WWW\xianzhitao\application\admin\view\public\left.html";i:1547878793;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="main-wrap">
    <div class="crumb-wrap">
        <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo url('admin/Index/index'); ?>">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">提现审核</span></div>
    </div>
    <div class="search-wrap">
        <div class="search-content">
            <form action="<?php echo url('admin/pay/txIndex'); ?>" id="myform" name="myform" method="post">
        ...
        <div class="result-content">
            <table class="result-tab" width="100%">
                ...
                <tr>
                    ...
                    <td><?php echo $vo['user_money']; ?> | <?php echo $vo['user_frozen_money']; ?></td>
                    <td><?php echo $vo['money']; ?></td>
                    <td><?php echo $vo['ip']; ?></td>
                    <td><?php echo $vo['cash_alipay_username']; ?></td>
                    <td><?php echo $vo['inputtime']; ?></td>
                    <td><?php echo $vo['audit_admin']; ?></td>
                    ...
                    <td>
                        <?php if($vo['status'] == 0): ?>
                        <a href="<?php echo url('admin/pay/txPass',['id' => $vo['id'],'userid' => $vo['userid'],'type' => 'pass']); ?>" onClick="return confirm('确定通过审核?');">通过</a>
                        <a href="<?php echo url('admin/pay/txPass',['id' => $vo['id'],'userid' => $vo['userid'],'type' => 'reject']); ?>" onClick="return confirm('确定驳回审核?');">驳回</a>
                        <?php endif; ?>
                    </td>
                </tr>
