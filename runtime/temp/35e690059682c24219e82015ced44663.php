...
<script>
	...
	$('#' + param).addClass('sign_dom');
            ...
            <div class="shopBind_right myfl">
                <p>请打开淘宝地址 www.taobao.com 登录淘宝账号 ，刷新页面确保已登录</p>
