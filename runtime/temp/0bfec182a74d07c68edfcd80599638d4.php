<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"C:\phpStudy\PHPTutorial\WWW\xianzhitao\public/../application/admin\view\pay\index.html";i:1547382894;s:78:"C:\phpStudy\PHPTutorial\WWW\xianzhitao\application\admin\view\public\left.html";i:1547878793;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="main-wrap">
    ...
    <div class="search-wrap">
        <div class="search-content">
            <form action="<?php echo url('admin/pay/index'); ?>" id="myform" name="myform" method="post">
        ...
        <div class="result-content">
            <table class="result-tab" width="100%">
                ...
                <tr>
                    ...
                    <td>
                        <?php if($vo['status'] == 0): ?>
                        <a href="<?php echo url('admin/pay/pass',['id' => $vo['id'],'userid' => $vo['userid'],'type' => 'pass']); ?>" onClick="return confirm('确定通过审核?');">通过</a>
                        <a href="<?php echo url('admin/pay/pass',['id' => $vo['id'],'userid' => $vo['userid'],'type' => 'reject']); ?>" onClick="return confirm('确定驳回审核?');">驳回</a>
                        <?php endif; ?>
                    </td>
                </tr>
