<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:90:"C:\phpStudy\PHPTutorial\WWW\xianzhitao\public/../application/admin\view\pay\vip_index.html";i:1550721384;s:78:"C:\phpStudy\PHPTutorial\WWW\xianzhitao\application\admin\view\public\left.html";i:1547878793;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="main-wrap">
    <div class="crumb-wrap">
        <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo url('admin/Index/index'); ?>">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">充值审核</span></div>
    </div>
    <div class="search-wrap">
        <div class="search-content">
            <!--<form action="<?php echo url('admin/pay/vipIndex'); ?>" id="myform" name="myform" method="post">
        ...
        <div class="result-content">
            <table class="result-tab" width="100%">
                ...
                <tr>
                    ...
                    <td>
                        <?php if($vo['vip_type'] == 1): ?><span style="color: green">白银会员</span>
                        <?php elseif($vo['vip_type'] == 2): ?> <span style="color: red">黄金会员</span>
                        <?php elseif($vo['vip_type'] == 3): ?> <span style="color: red">钻石会员</span>
                        <?php endif; ?>
                    </td>
                    <td><?php echo $vo['money']; ?></td>
                    <td><?php echo $vo['tran_number']; ?></td>
                    <td>
                        <?php if($vo['status'] == 1): ?><span style="color: green">已通过</span>
                        <?php elseif($vo['status'] == -1): ?> <span style="color: red">驳回</span>
                        <?php else: ?>
                        等待审核
                        <?php endif; ?>
                    </td>
                    ...
                    <td>
                        <?php echo $vo['check_admin']; ?>
                    </td>
                    <td>
                        <?php echo $vo['check_time']; ?>
                    </td>


                    <td>
                        <?php if($vo['status'] == 0): ?>
                        <a href="<?php echo url('admin/pay/passVip',['id' => $vo['id'],'userid' => $vo['userid'],'type' => 'pass']); ?>" onClick="return confirm('确定通过审核?');">通过</a>
                        <a href="<?php echo url('admin/pay/passVip',['id' => $vo['id'],'userid' => $vo['userid'],'type' => 'reject']); ?>" onClick="return confirm('确定驳回审核?');">驳回</a>
                        <?php endif; ?>
                    </td>
                </tr>
