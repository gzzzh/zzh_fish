<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:95:"C:\phpStudy\PHPTutorial\WWW\xianzhitao\public/../application/admin\view\audit\alipay_index.html";i:1545717391;s:78:"C:\phpStudy\PHPTutorial\WWW\xianzhitao\application\admin\view\public\left.html";i:1547878793;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="main-wrap">
    ...
    <div class="crumb-wrap">
        <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo url('admin/Index/index'); ?>">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">支付宝列表</span></div>
    </div>
    <div class="search-wrap">
        <div class="search-content">
            <form action="<?php echo url('admin/Audit/userAliList'); ?>" method="get">
        ...
        <div class="result-content">
            <table class="result-tab" width="100%">
                ...
                <tr>
                    ...
                    <td class="idcards">
                        <a href="/<?php echo $vo['alipay_imgs']; ?>" target="_blank"><img src="/<?php echo $vo['alipay_imgs']; ?>"/></a>
                    </td>
                    ...
                    <td>
                        <?php if($vo['status'] == 1): ?>
                        <a href="<?php echo url('admin/Audit/alipayAudit',['id' => $vo['id'],'userid' => $vo['userid'],'type' => 'pass']); ?>">通过</a>
                        <a href="<?php echo url('admin/Audit/alipayAudit',['id' => $vo['id'],'userid' => $vo['userid'],'type' => 'reject']); ?>">驳回</a>
                        <?php endif; ?>
                    </td>
                </tr>
