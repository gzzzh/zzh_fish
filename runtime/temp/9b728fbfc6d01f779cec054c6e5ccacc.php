<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:89:"C:\phpStudy\PHPTutorial\WWW\xianzhitao\public/../application/admin\view\category\add.html";i:1547724425;s:78:"C:\phpStudy\PHPTutorial\WWW\xianzhitao\application\admin\view\public\left.html";i:1547878793;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="main-wrap">
    <div class="crumb-wrap">
        <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo url('admin/Index/index'); ?>">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">分类管理</span></div>
    </div>
    <div class="result-wrap">
        <form action="<?php echo url('admin/Category/save'); ?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
            <div class="config-items">
                <div class="config-title">
                    <h1><i class="icon-font">&#xe00a;</i><?php echo !empty($info)?'编辑分类' : '添加分类'; ?></h1>
                </div>
                <div class="result-content">
                    <table width="100%" class="insert-tab">
                        ...
                        <tr>
                            ...
                            <td><input type="text"  value="<?php echo (isset($info['catname']) && ($info['catname'] !== '')?$info['catname']:''); ?>" size="85" name="catname" class="common-text"></td>
                        </tr>
                        <tr>
                            <th width="15%"><i class="require-red">*</i>分类图片：</th>
                            <td><img style="width:400px;" src="/<?php echo (isset($info['image']) && ($info['image'] !== '')?$info['image']:''); ?>"></td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>分类上传：</th>
                            <td><input type="file" name="image" class="common-text"></td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>分类描述：</th>
                            <td><input type="text"  value="<?php echo (isset($info['description']) && ($info['description'] !== '')?$info['description']:''); ?>" size="85" name="description" class="common-text"></td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>排序：</th>
                            <td><input type="text"  value="<?php echo (isset($info['sort']) && ($info['sort'] !== '')?$info['sort']:''); ?>" size="40" name="sort" class="common-text">
                            默认为最大的排序号
                            </td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>显示：</th>
                            <td>
                                <select name="ismenu" style="width: 200px;height: 29px;">

                                    <?php if(empty($info) || (($info instanceof \think\Collection || $info instanceof \think\Paginator ) && $info->isEmpty())): ?>
                                    <option value="1">显示</option>
                                    <option value="2">不显示</option>
                                    <?php else: ?>
                                    <option value="1" <?php if($info['ismenu'] == 1): ?>selected<?php endif; ?>>显示</option>
                                    <option value="2" <?php if($info['ismenu'] == 2): ?>selected<?php endif; ?>>不显示</option>
                                    <?php endif; ?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?php echo url('admin/Category/index'); ?>"><input type="button" value="返回"  class="btn btn6"></a>
                            </td>
                        </tr>
                        </tbody>
                    </table>
