<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:91:"C:\phpStudy\PHPTutorial\WWW\xianzhitao\public/../application/admin\view\category\index.html";i:1547882248;s:78:"C:\phpStudy\PHPTutorial\WWW\xianzhitao\application\admin\view\public\left.html";i:1547878793;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="main-wrap">
    <div class="crumb-wrap">
        <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo url('admin/Index/index'); ?>">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">活动分类管理</span></div>
    </div>

    <div class="result-wrap">
        <div class="result-title">
            <div class="result-list">
                <a href="<?php echo url('admin/category/add'); ?>"><i class="icon-font"></i>新增分类</a>
            </div>
        </div>
        <div class="result-content">
            <table class="result-tab" width="100%">
                ...
                <tr>
                    ...
                    <td><img src="/<?php echo $vo['image']; ?>" width="50px" height="50px"></td>
                    <td><?php echo $vo['description']; ?></td>
                    <td><?php echo $vo['sort']; ?></td>


                    <td>
                        <?php if($vo['ismenu'] == 1): ?>显示
                        <?php else: ?>不显示
                        <?php endif; ?>
                    </td>
                    ...
                    <td>
                        <a href="<?php echo url('admin/category/add',['id' => $vo['id']]); ?>">编辑</a>
                        &nbsp;&nbsp;
                        <a class="link-del" href="<?php echo url('admin/category/del',['id' => $vo['id']]); ?>}" onClick="return confirm('确定操作数据?');">删除</a>
                    </td>
                </tr>
